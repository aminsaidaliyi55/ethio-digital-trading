...
<div class="container">
    <h2>daily Reports</h2>
<p>Approved orders placed on {{ now()->format('F j, Y') }}</p>

  

    {{-- Buttons for Print and PDF Download --}}
 <a href="{{ route('dailyreport.downloadPdf', request()->only('search', 'perPage')) }}" class="btn btn-success btn-sm">
    Download PDF
</a>
    ...
    {{-- Orders Table --}}
    <form action="{{ route('dailyreport.index') }}" method="GET" class="mb-4 no-print">
        <div class="row">
            <div class="col-md-4">
                <input 
                    type="text" 
    ...
    <div class="print-area">
        ...
        <div class="table-responsive" style="max-height: 300px; overflow-y: auto;">
            <table class="table table-bordered table-sm">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="14">No approved orders found for this dail.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        {{-- Total Approved daily Revenue --}}
      
    </div>
    <div class="mt-4">
            <h4>Total Approved daily Revenue: {{ number_format($totalApprovedPrice, 2) }}</h4>
        </div>
</div>
@endsection
